...
$ambil = mysqli_query($conn, "SELECT max(kd_permintaan) as maxKode FROM permintaan");
...
$noUrut++;
$char = "PM-";
$kd_permintaan = $char . sprintf("%03s", $noUrut);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Apochecker | Tambah Permintaan</title>
                            ...
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="kd_permintaan">Kode Permintaan</label>
                                        <input type="text" class="form-control disabled" id="kd_permintaan" required=""
                                            name="kd_permintaan" value="<?= $kd_permintaan; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <a class="btn btn-outline-primary" href="manajemen-permintaan.php"
...
if (isset($_POST['tambah'])) {
    ...
    $kd_permintaan = $kd_permintaan;
    $ktgr = $_POST['jenis_obat'];
    $bln = $_POST['bulan'];
    $thn = $_POST['tahun'];
    $jml = $_POST['jml_obat'];
    $simpan =mysqli_query($conn, "INSERT INTO permintaan
		(kd_permintaan,bulan,tahun,jenis_obat,jumlah_obat) VALUES 
		('$kd_permintaan','$bln','$thn','$ktgr','$jml')");
    
   
     
     if ($simpan) {
         echo "<script>
	  	document.location='manajemen-permintaan.php';
