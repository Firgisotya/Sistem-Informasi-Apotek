...
error_reporting(0);
if (isset($_GET['kd_permintaan'])) {
	$kd = $_GET['kd_permintaan'];
} else {
	echo "<script>alert('Kode Permintaan Belum Dipilih');document.location='manajemen-permintaan.php'</script>";
}
$data = mysqli_query($conn,"SELECT * FROM permintaan where kd_permintaan='$kd'")or die(mysqli_error());
...
<head>
    ...
    <title>Apochecker | Edit Permintaan</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Permintaan</h1>
                    </div>
                            ...
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="hidden" name="kd_permintaan"
                                            value="<?php echo $daftar['kd_permintaan']; ?>">
                                        <label>Kode Permintaan</label>
                                        <input type="text" class="form-control" id="kd_permintaan" placeholder=""
                                            required="" name="kd_permintaan"
                                            value="<?php echo $daftar['kd_permintaan'];?>" readonly="">
                                    </div>
                                    <div class="form-group">
                                        <label>Bulan</label>
...
if (isset($_POST['edit'])) {
	...
	$kd = $_POST['kd_permintaan'];
    $ktgr = $_POST['jenis_obat'];
	$bln = $_POST['bulan'];
	$thn = $_POST['tahun'];
	$jml = $_POST['jumlah_obat'];

		$edit = mysqli_query($conn,"UPDATE permintaan SET bulan='$bln',jenis_obat='$ktgr',tahun='$thn', jumlah_obat='$jml' where kd_permintaan='$kd'");
		if($edit){
			echo "<script>alert('Data Permintaan berhasil diedit'); document.location='manajemen-permintaan.php'</script>";
		} else {
			echo "<script>alert('Data Permintaan gagal diedit')</script>";
