...
$ambil = mysqli_query($conn, "SELECT max(kd_produksi) as maxKode FROM produksi");
...
$noUrut++;
$char = "PR-";
$kd_produksi = $char . sprintf("%03s", $noUrut);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Apochecker | Tambah Produksi</title>
                            ...
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="kd_produksi">Kode Produksi</label>
                                        <input type="text" class="form-control disabled" id="kd_produksi" required=""
                                            name="kd_produksi" value="<?= $kd_produksi; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <a class="btn btn-outline-primary" href="manajemen-produksi.php"
...
if (isset($_POST['tambah'])) {
    ...
    $thn = $_POST['tahun'];
    $jml = $_POST['jml_obat'];
    $simpan =mysqli_query($conn, "INSERT INTO produksi
		(kd_produksi,bulan,tahun,jenis_obat,jumlah_obat) VALUES 
		('$kd_produksi','$bln','$thn','$ktgr','$jml')");
    
   
     
     if ($simpan) {
         echo "<script>
	  	document.location='manajemen-produksi.php';
	 	alert('Data Produksi berhasil disimpan')
        
         </script>";
    } else {
         echo "<script>alert('Data Produksi berhasil disimpan')</script>";
    }
}
?>