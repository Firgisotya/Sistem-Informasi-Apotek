...
<head>
    ...
    <title>Apochecker | Histori Penjualan</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        if ($txtcari == !"") {
                            ...
                            $query = mysqli_query($conn, "SELECT * FROM tbl_transaksi, user, tbl_obat WHERE tbl_transaksi.id_user = user.id_user AND tbl_transaksi.kd_obat = tbl_obat.kd_obat ORDER BY tbl_transaksi.kd_transaksi DESC");
                        }
                            ...
                            while ($data = mysqli_fetch_array($query)) { ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?= $data['total']; ?></td>
                                                    <td><img src="../img/bank/<?php echo $data['pembayaran']; ?>.png"
                                                            width="60px" height="70px"
                                                            alt="<?php echo $data['pembayaran'] ?>"></td>
                                                    <td><img src="../img/bukti/<?php echo $data['bukti']; ?>"
